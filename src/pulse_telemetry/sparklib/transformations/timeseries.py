...
timeseries_schema = T.StructType(
    [
        ...
        T.StructField("test_id", dataType=T.StringType(), nullable=False),  # ID of the sequence (i.e. test) being measured by the device
        ...
        T.StructField("capacity__Ah", dataType=T.DoubleType(), nullable=False),  # Capacity accumulated during this record
